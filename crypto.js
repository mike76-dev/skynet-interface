...
// AES key (256 bit) and CBC mode initialization vector

// currently hardcoded but could be produced another way for better security,

// e.g. derived from appId

const aesKey = aes.utils.utf8.toBytes('Welcome to the world of crypto!!');

const aesIV = aes.utils.utf8.toBytes('Have a nice day!');
...
export async function generateSeed(login, password) {
...
export async function recoverPassword(seed) {
